...
- Cobertura (`flutter test --coverage` + `lcov --summary`): 91.6% (164/179 líneas, 23 archivos) antes de orders; 86.2% (206/239 líneas, 31 archivos) tras agregar orders (stubs nuevos reducen el porcentaje).
