...
void main() {
  ...
  setUp(() {
    ...
    sut = RefreshDemoUseCase(mockRepository);
  });

  group('RefreshDemoUseCase', () {
    group('casos de éxito', () {
      test('debe retornar void cuando la operación es exitosa', () async {
        // Arrange
        when(() => mockRepository.refreshDemo(
        ...
        verify(() => mockRepository.refreshDemo(
        )).called(1);
      });
    });
